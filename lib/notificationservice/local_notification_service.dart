...
class LocalNotificationService {
  ...
  static void initialize(BuildContext context) {
    // InitializationSettings, you can specify how the notifications should behave on different platforms,such as which icon to use,
    ...
    /*onDidReceiveNotificationResponse  can be used to handle user interactions with the notification,
